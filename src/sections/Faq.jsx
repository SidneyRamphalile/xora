    ...
    <section>
      <Element name="faq" className="relative">
        <div className="container relative z-2 py-28">
          <div>
            <h3 className="h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7 text-primaryText">
        ...
        <div className="faq-glow_before relative z-2 border-2 border-borderColour bg-backgroundColour">
          ...
          <div className="faq-lin_after absolute left-[calc(50%-1px)] top-0 -z-1 h-full w-0.5 bg-borderColour max-lg:hidden" />
        </div>
      </Element>
    </section>
  );
